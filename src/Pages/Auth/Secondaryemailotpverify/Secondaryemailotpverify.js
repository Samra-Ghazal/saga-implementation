...
import { loginUser, resendnewsecondaryemailotp, sendotopemail, verifysecondaryemail } from "../../../Store/Auth/actions";
...
export default function Secondaryemailotpverify(props) {
  ...
  const getdataofregistereduser = useSelector(
    (state) => state.Auth?.secondaryEmail
  );
   //////////////////////
  ...
  const handleSubmit = () => {
    dispatch(
      verifysecondaryemail({
        otpCode: otp,
        email: getdataofregistereduser,
        userId: userid,
        setIsLoading,
      })
    );
  };
  const resendotpsecondaryemailoncall = () =>{
    dispatch(
      resendnewsecondaryemailotp({
        id: userid,
        type: 2,
        // history: history,
        // setIsLoading,
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-4 pt-3">
                      ...
                      <div className="col-md-12 text-center">
                        ...
                        {isActive?  <p className="mb-0 resend_button_disabled"  >Resend Code</p> :  <p className="mb-0 resend_button" onClick={resendotpsecondaryemailoncall} >Resend Code</p> }
                        {isLoadingresend ? (
                              <div
